...
std::string NX::sconfig::load(const std::wstring& file, const std::vector<unsigned char>& key)
{
    std::ifstream fs;
...
void NX::sconfig::save(const std::wstring& file, const std::string& data, const std::vector<unsigned char>& key)
{
    std::ofstream fs;
