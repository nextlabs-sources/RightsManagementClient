...
public:
    ...
    inline const std::vector<std::shared_ptr<CLabelValue>>& GetValues() const throw() {return _values;}
    inline std::vector<std::shared_ptr<CLabelValue>>& GetValues() throw() {return _values;}
...
private:
    ...
    std::vector<std::shared_ptr<CLabelValue>> _values;
};
...
public:
    ...
    inline const std::shared_ptr<CLabel>& GetSubLabel() const throw() {return _sublabel;}
    inline std::shared_ptr<CLabel>& GetSubLabel() throw() {return _sublabel;}
...
private:
    std::wstring _value;
    std::shared_ptr<CLabel> _sublabel;
};
...
public:
    ...
    CLabel* LoadLabels(_In_opt_ const std::wstring& lang);
