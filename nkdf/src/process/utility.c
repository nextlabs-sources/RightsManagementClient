                              ...
                              )
{
    ...
    try {
        ...
        ImageFileName = (PUNICODE_STRING)ExAllocatePoolWithTag(NonPagedPool, InfoLength, TAG_TEMP);
                  ...
                  )
{
    ...
    *Result = FALSE;
    ...
    try {
        ...
        ReturnedLength *= 2;
        TokenUserInfo = ExAllocatePoolWithTag(NonPagedPool, ReturnedLength, TAG_TEMP);
