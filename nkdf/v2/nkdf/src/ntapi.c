    ...
    )
{
    ...
    try {
        ...
        InfoBuf = ExAllocatePoolWithTag(PagedPool, Size * 2, TAG_TMP);
        if (NULL == InfoBuf) {
    ...
    )
{
    ...
    UNREFERENCED_PARAMETER(Virtual);
    ...
    )
{
    ...
    UNREFERENCED_PARAMETER(MemoryInformationClass);
    UNREFERENCED_PARAMETER(MemoryInformation);
    UNREFERENCED_PARAMETER(MemoryInformationLength);
