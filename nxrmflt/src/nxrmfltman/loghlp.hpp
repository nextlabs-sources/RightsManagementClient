...
#define LOGMAN(MGR, LEVEL, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LEVEL)) { \
        ...
        ((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback(le.GetData().c_str()); \
    }
...
#define LOGMAN_ASSERT(MGR, CODE, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LOGCRITICAL)) { \
...
#define LOGMAN_ERROR(MGR, CODE, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LOGERROR)) { \
...
#define LOGMAN_WARN(MGR, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LOGWARNING)) { \
...
#define LOGMAN_INFO(MGR, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LOGINFO)) { \
        nudf::util::log::CLogEntry le(LOGINFO, NXMODNAME(), INFO, __VA_ARGS__); \
        ((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback(le.GetData().c_str()); \
    }

#define LOGMAN_DBG(MGR, INFO, ...) \
    if(NULL!=MGR && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback && NULL!=((PNXRMFLT_MANAGER)MGR)->DebugDumpCallback && ((PNXRMFLT_MANAGER)MGR)->DebugDumpCheckLevelCallback(LOGDEBUG)) { \
