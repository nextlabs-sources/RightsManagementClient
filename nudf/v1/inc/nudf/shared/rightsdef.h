...
__forceinline
ULONGLONG DisplayNameToRights(_In_ LPCWSTR display_name)
{
    if (0 == _wcsicmp(RIGHT_DISP_VIEW, display_name)) {
        return BUILTIN_RIGHT_VIEW;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_EDIT, display_name)) {
        return BUILTIN_RIGHT_EDIT;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_PRINT, display_name)) {
        return BUILTIN_RIGHT_PRINT;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_CLIPBOARD, display_name)) {
        return BUILTIN_RIGHT_CLIPBOARD;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_SAVEAS, display_name)) {
        return BUILTIN_RIGHT_SAVEAS;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_DECRYPT, display_name)) {
        return BUILTIN_RIGHT_DECRYPT;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_SCREENCAP, display_name)) {
        return BUILTIN_RIGHT_SCREENCAP;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_SEND, display_name)) {
        return BUILTIN_RIGHT_SEND;
    }
    else if (0 == _wcsicmp(RIGHT_DISP_CLASSIFY, display_name)) {
        return BUILTIN_RIGHT_CLASSIFY;
    }
    else {
        return 0ULL;
